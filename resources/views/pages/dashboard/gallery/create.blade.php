            ...
            <form action="{{ route('dashboard.product.gallery.store', $product->id) }}" class="w-full" method="post" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap mb-6 -mx-3">
                    <div class="w-full px-3">
                        ...
                        <input type="file" multiple name="files[]" accept="image/*" placeholder="Photos" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-700 rounded focus:outline-none focus:bg-white focus:border-gray-500">
                    </div>
                </div>
                <div class="flex flex-wrap mb-6 -mx-3">
                    <div class="w-full px-3">
